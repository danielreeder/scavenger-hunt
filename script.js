...
dock_box.forEach(box => {
    box.addEventListener('click', (event) => {
        ...
        if (placed === 1){
            ...
            clue.innerHTML = "6 letters is all you will need to solve this next clue. Which letters? Hmm, hard to say. Unfortunately, individual letters are prone to being scattered about by the gradient lords. Fickle beings, those ones."
